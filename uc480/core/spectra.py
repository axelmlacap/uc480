...
from uc480.utilities.save import SaveManager, PATH
...
class SpectraSave(SaveManager, Backend):
    ...
    def __init__(self, spectra_analyzer_be: SpectraAnalyzer):
        ...
        if isinstance(spectra_analyzer_be, type(None)):
            callback = None
            trigger = None
        else:
            callback = spectra_analyzer_be.spectrum.save
            trigger = spectra_analyzer_be.spectrum.raw.buffer.was_filled
