...
class BidirectionalDict(dict):
    ...
    def __init__(self, direct_dict):
        
        self._direct = direct_dict
        self._inverse = {value: key for key, value in direct_dict.items()}
        self._key_type = type(list(direct_dict.keys())[0])
        self._value_type = type(list(direct_dict.values())[0])
        self.values = self._direct.values
        self.keys = self._direct.keys
    ...
    def __getitem__(self, arg):
        ...
        if isinstance(arg, self._key_type):
            return self._direct[arg]
        
        elif isinstance(arg, self._value_type):
            return self._inverse[arg]
        
        else:
            raise TypeError('Argument type does not match a key or value type.')
    
    def __setitem__(self, key, value):
        raise AttributeError("Value setter not implemented. Object is immutable.")


true_false = BidirectionalDict({False: 0,
                                True: 1})

timeout = BidirectionalDict({'IS_GET_LIVE': 0x8000,
                             'IS_WAIT': 0x0001,
                             'IS_DONT_WAIT': 0x0000})
    
display_mode = BidirectionalDict({'IS_SET_DM_DIB': 1,
                                  'IS_SET_DM_DIRECT3D': 4,
                                  'IS_SET_DM_OPENGL': 8,
                                  'IS_GET_DISPLAY_MODE': 0x8000})

image_color_mode = BidirectionalDict({'IS_GET_COLOR_MODE': 0x8000,
                                      ...
                                      'IS_CM_MONO12': 26,
                                      'IS_CM_MONO16': 28,
                                      'IS_CM_BGR5_PACKED': (3|0x0000),
                                      'IS_CM_BGR565_PACKED': (2|0x0000),
                                      'IS_CM_RGB8_PACKED': (1|0x0000),
                                      'IS_CM_BGR8_PACKED': (1|0x0000),
                                      'IS_CM_RGBA8_PACKED': (0|0x0000),
                                      'IS_CM_BGRA8_PACKED': (0|0x0000),
                                      'IS_CM_RGBY8_PACKED': (24|0x0000),
                                      'IS_CM_BGRY8_PACKED': (24|0x0000),
                                      'IS_CM_RGB10_PACKED': (25|0x0000),
                                      'IS_CM_BGR10_PACKED': (25|0x0000),
                                      'IS_CM_RGB10_UNPACKED': (35|0x0000),
                                      'IS_CM_BGR10_UNPACKED': (35|0x0000),
                                      'IS_CM_RGB12_UNPACKED': (30|0x0000),
                                      'IS_CM_BGR12_UNPACKED': (30|0x0000),
                                      'IS_CM_RGBA12_UNPACKED': (31|0x0000),
                                      'IS_CM_BGRA12_UNPACKED': (31|0x0000),
                                      'IS_CM_JPEG': 32,
                                      'IS_CM_UYVY_PACKED': 12,
                                      'IS_CM_UYVY_MONO_PACKED': 13,
                                      'IS_CM_UYVY_BAYER_PACKED': 14,
                                      'IS_CM_CBYCRY_PACKED': 23,
                                      'IS_CM_RGB8_PLANAR': (1|0x0000|0x2000),
                                      'IS_CM_ALL_POSSIBLE': 0xFFFF,
                                      'IS_CM_MODE_MASK': 0x007F})

sensor_color_mode = BidirectionalDict({'IS_COLORMODE_INVALID': 0,
                                       'IS_COLORMODE_MONOCHROME': 1,
                                       'IS_COLORMODE_BAYER': 2,
                                       'IS_COLORMODE_CBYCRY': 4,
                                       'IS_COLORMODE_JPEG': 8})

trigger = BidirectionalDict({'IS_GET_EXTERNALTRIGGER': 0x8000,
                             ...
                             'IS_SET_TRIGGER_HI_LO': (0x1000|0x0001),
                             'IS_SET_TRIGGER_LO_HI': (0x1000|0x0002),
                             'IS_SET_TRIGGER_SOFTWARE': (0x1000|0x0008),
                             'IS_SET_TRIGGER_HI_LO_SYNC': 0x0010,
                             'IS_SET_TRIGGER_LO_HI_SYNC': 0x0020,
                             'IS_SET_TRIGGER_PRE_HI_LO': (0x1000|0x0040),
                             'IS_SET_TRIGGER_PRE_LO_HI': (0x1000|0x0080),
                             'IS_GET_TRIGGER_DELAY': 0x8000})

set_aoi = BidirectionalDict({'IS_AOI_IMAGE_SET_AOI': 0x0001,
...
aoi = BidirectionalDict({'IS_AOI_IMAGE_SET_AOI': 0x0001,
                         'IS_AOI_IMAGE_GET_AOI': 0x0002,
                         'IS_AOI_IMAGE_SET_POS': 0x0003,
                         'IS_AOI_IMAGE_GET_POS': 0x0004,
                         'IS_AOI_IMAGE_SET_SIZE': 0x0005,
...
sensor_id = BidirectionalDict({'IS_SENSOR_INVALID': 0x0000,
...
error = BidirectionalDict({'IS_NO_SUCCESS': -1,
                           'IS_SUCCESS': 0,
